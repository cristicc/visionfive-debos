...
user@visionfive-build:~/visionfive-debos$ ls
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos$ alias kmake
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos$ mkdir work && cd work
user@visionfive-build:~/visionfive-debos/work$
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work$ git clone -o linux git://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git
user@visionfive-build:~/visionfive-debos/work$ cd linux
# Skip the commands below if linux-next is not of interest.
user@visionfive-build:~/visionfive-debos/work/linux$ git remote add linux-next git://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git
user@visionfive-build:~/visionfive-debos/work/linux$ git fetch linux-next
user@visionfive-build:~/visionfive-debos/work/linux$ git worktree add --checkout -b linux-next ../linux-next next-20221028
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ git remote add starfive git@github.com:starfive-tech/linux.git
user@visionfive-build:~/visionfive-debos/work/linux$ git fetch starfive
user@visionfive-build:~/visionfive-debos/work/linux$ git worktree add --checkout -b linux-starfive ../linux-starfive starfive/visionfive
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ b4 am -l 20221017210542.979051-1-cristian.ciocaltea@collabora.com
user@visionfive-build:~/visionfive-debos/work/linux$ git am ./v4_20221018_cristian_ciocaltea_enable_initial_support_for_starfive_visionfive_v1_sbc.mbx
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ git am --empty=drop ../../linux/patches/*.patch
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ mkdir -p build
user@visionfive-build:~/visionfive-debos/work/linux$ cp ../../linux/visionfive_defconfig build/.config
user@visionfive-build:~/visionfive-debos/work/linux$ kmake olddefconfig
----
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ kmake
[...]
...
[source,sh]
----
user@visionfive-build:~/visionfive-debos/work/linux$ kmake bindeb-pkg
user@visionfive-build:~/visionfive-debos/work/linux$ ls -1 *.deb
...
user@visionfive-build:~/visionfive-debos/work/linux$ mkdir build/dist
user@visionfive-build:~/visionfive-debos/work/linux$ kmake INSTALL_PATH=dist zinstall dtbs_install
----
